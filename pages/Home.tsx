...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    // تحديث الألوان في الجذر عند التحميل
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-l from-lebanese-green/80 via-lebanese-green/60 to-transparent" style={{ backgroundImage: `linear-gradient(to left, ${settings.primaryColor}CC, ${settings.primaryColor}99, transparent)` }}></div>
        </div>
        
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-white text-right">
          <div className="max-w-3xl animate-fade-in">
            <span className="inline-block bg-lebanese-bronze px-4 py-1.5 rounded text-sm font-bold mb-6 tracking-wider shadow-lg" style={{ backgroundColor: settings.accentColor }}>
          ...
          <div className="bg-white p-10 md:p-14 rounded-[3rem] shadow-2xl grid grid-cols-2 md:grid-cols-4 gap-12 border border-lebanese-bronze/5">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-5xl font-black text-lebanese-green mb-3" style={{ color: settings.primaryColor }}>{stat.val}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-20 gap-8">
            <div className="text-center md:text-right">
              <span className="text-lebanese-bronze font-black text-lg mb-4 block" style={{ color: settings.accentColor }}>عقارات مختارة بعناية</span>
              <h2 className="text-5xl font-black text-lebanese-green" style={{ color: settings.primaryColor }}>استكشف أرقى العروض</h2>
            </div>
      ...
      <section className="py-32 bg-lebanese-stone">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-lebanese-green p-16 md:p-24 rounded-[4rem] shadow-2xl text-center relative overflow-hidden group" style={{ backgroundColor: settings.primaryColor }}>
